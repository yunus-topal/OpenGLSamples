...
void Program4_4::init(GLFWwindow* window) {
	renderingProgram = shader_utils::createShaderProgram("vertShader_4_4.glsl", "fragShader_4_4.glsl");
...
void Program4_4::setupVertices(void) {
