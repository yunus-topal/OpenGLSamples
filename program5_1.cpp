...
void Program5_1::init(GLFWwindow* window) {
...
void Program5_1::display(GLFWwindow* window, double currentTime) {
...
void Program5_1::execute() {
	if (!glfwInit()) { exit(EXIT_FAILURE); }
	glfwWindowHint(GLFW_CONTEXT_VERSION_MAJOR, 4);
	glfwWindowHint(GLFW_CONTEXT_VERSION_MINOR, 3);
	GLFWwindow* window = glfwCreateWindow(600, 800, "Chapter5 - program1", NULL, NULL);
	...
	glfwSetWindowSizeCallback(window, [](GLFWwindow* w, int newWidth, int newHeight) {
		auto* self = static_cast<Program5_1*>(glfwGetWindowUserPointer(w));
...
void Program5_1::setupVertices(void) {
...
void Program5_1::window_reshape_callback(int newWidth, int newHeight) {
